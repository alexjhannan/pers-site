...
const composerFxn = (props, onData) => {
	let links = [
		...
		{desc: "Standpoint Theory: Understand Stuff More Good", href:"https://en.wikipedia.org/wiki/Standpoint_theory"},
		...
		{desc: "Frontend Masters: Workshops for Web Education", href: "frontendmasters.com"},
